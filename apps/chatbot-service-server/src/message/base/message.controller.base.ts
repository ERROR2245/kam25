...
import { ChatbotResponseFindManyArgs } from "../../chatbotResponse/base/ChatbotResponseFindManyArgs";
...
export class MessageControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/chatbotResponses")
  ...
  async findChatbotResponses(
    @common.Req() request: Request,
    @common.Param() params: MessageWhereUniqueInput
  ): Promise<ChatbotResponse[]> {
    const query = plainToClass(ChatbotResponseFindManyArgs, request.query);
    const results = await this.service.findChatbotResponses(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/chatbotResponses")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async connectChatbotResponses(
    @common.Param() params: MessageWhereUniqueInput,
    @common.Body() body: ChatbotResponseWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      chatbotResponses: {
        connect: body,
  ...
  @common.Patch("/:id/chatbotResponses")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async updateChatbotResponses(
    @common.Param() params: MessageWhereUniqueInput,
    @common.Body() body: ChatbotResponseWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/chatbotResponses")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async disconnectChatbotResponses(
    @common.Param() params: MessageWhereUniqueInput,
    @common.Body() body: ChatbotResponseWhereUniqueInput[]
  ): Promise<void> {
    const data = {
